...
import com.practice.gmailcloneui.model.Account
import com.practice.gmailcloneui.model.MailData
...
val accountList = listOf<Account>(
    Account(
        ...
        userName = "Mihai Pavel",
        email = "pavelmihail@gmail.com",
        unreadMails = 99
    ),
    Account(
        userName = "Gorge Bush",
    ...
    Account(
        userName = "Siminon Ionescu",
        email = "siminonion@gmail.com",
        unreadMails = 99
    )
)